    ...
    public function launch_application($data = [])
{
    ...
    // Check if $result is a string and needs to be decoded
    if (is_string($result)) {
        $result = json_decode($result, true); // Convert JSON string to associative array
    }

    // Ensure $result is an array and contains 'status' key
